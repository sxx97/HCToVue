...
<!--                            <td class="text-center">{{ownerRepair.repairId}}</td>-->
    ...
    <vc:create name="ownerRepairDetail"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import OwnerRepairDetail from '@/component/OwnerRepairDetail.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,OwnerRepairDetail
                },
                data () {
                    return {"repairDispatchManageInfo":{"ownerRepairs":[],"total":0,"records":1,"moreCondition":false,"repairName":"","conditions":{"repairId":"","repairName":"","tel":"","repairType":"","roomId":"","roomName":"","ownerId":"","state":""}}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            ...
            this.$vc.on('repairDispatchManage','listOwnerRepair',(_param) =>{
                  this._listOwnerRepairs(DEFAULT_PAGE, DEFAULT_ROWS);
            });
