    ...
    <div class="row">
        ...
        <script>
            ...
            import ViewSelectParkingSpace from '@/component/ViewSelectParkingSpace.vue';import ViewOwnerInfo from '@/component/ViewOwnerInfo.vue';import AddCar from '@/component/AddCar.vue';import SellParkingSpaceFee from '@/component/SellParkingSpaceFee.vue';
            ...
            export default {
                props: {},
                components: {
                    ViewSelectParkingSpace,ViewOwnerInfo,AddCar,SellParkingSpaceFee
                },
                data () {
                    return {"sellParkingSpaceInfo":{"$step":{},"index":0,"infos":[]}}    
                },
                mounted() {
                (() =>{
            this._initStep();
...
(() =>{
           ...
           this.$vc.on("sellParkingSpace", "notify", (_info) =>{
