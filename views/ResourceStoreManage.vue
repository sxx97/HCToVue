    ...
    <vc:create name="deleteResourceStore"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import AddResourceStore from '@/component/AddResourceStore.vue';import EditResourceStore from '@/component/EditResourceStore.vue';import DeleteResourceStore from '@/component/DeleteResourceStore.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,AddResourceStore,EditResourceStore,DeleteResourceStore
                },
                data () {
                    return {"resourceStoreManageInfo":{"resourceStores":[],"total":0,"records":1,"moreCondition":false,"resName":"","conditions":{"resId":"","resName":"","resCode":""}}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            ...
            this.$vc.on('resourceStoreManage','listResourceStore',(_param) =>{
                  this._listResourceStores(DEFAULT_PAGE, DEFAULT_ROWS);
            });
             this.$vc.on('pagination','page_event',(_currentPage) =>{
               ...
               this.$vc.http.get('resourceStoreManage',
                ...
                this.$vc.emit('editResourceStore','openEditResourceStoreModal',_resourceStore);
