...
<!--                        </button>-->
    ...
    ></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import SearchFloor from '@/component/SearchFloor.vue';import RoomCreateFeeAdd from '@/component/RoomCreateFeeAdd.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,SearchFloor,RoomCreateFeeAdd
                },
                data () {
                    return {"roomUnits":[],"roomCreateFeeInfo":{"rooms":[],"total":0,"records":1,"floorId":"","unitId":"","state":"","roomNum":"","moreCondition":false,"conditions":{"floorId":"","floorName":"","unitId":"","roomNum":"","roomId":"","state":"","section":""}}}    
                },
                mounted() {
                (() =>{
