    ...
    >
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"auditAppUserBindingOwnerManageInfo":{"auditAppUserBindingOwners":[],"total":0,"records":1,"moreCondition":false,"currentAppUserId":"","name":"","conditions":{"appUserName":"","idCard":"","link":"","state":""}},"ownerTypeText":{"1001":"业主","1002":"家庭成员","1003":"租客","1004":"访客","1005":"企业员工"},"auditStateName":{"10000":"待审核","12000":"通过","13000":"不通过","14000":"待审核","15000":"通过","16000":"不通过"}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            ...
            this.$vc.on('auditAppUserBindingOwnerManage','listAuditAppUserBindingOwner',(_param) =>{
                  this._listAuditAppUserBindingOwners(DEFAULT_PAGE, DEFAULT_ROWS);
            });

             this.$vc.on('auditAppUserBindingOwnerManage', 'auditMessage',  (_auditInfo) => {
