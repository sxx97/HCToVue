    ...
    <vc:create name="deletePurchaseApply"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import AddPurchaseApply from '@/component/AddPurchaseApply.vue';import EditPurchaseApply from '@/component/EditPurchaseApply.vue';import DeletePurchaseApply from '@/component/DeletePurchaseApply.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,AddPurchaseApply,EditPurchaseApply,DeletePurchaseApply
                },
                data () {
                    return {"purchaseApplyManageInfo":{"purchaseApplys":[],"total":0,"records":1,"moreCondition":false,"applyOrderId":"","conditions":{"state":"","applyOrderId":""}}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            ...
            this.$vc.on('purchaseApplyManage','listPurchaseApply',(_param) =>{
                  this._listPurchaseApplys(DEFAULT_PAGE, DEFAULT_ROWS);
            });
