...
<!--                                <button class="btn btn-default" type="button" @click="_resourceStoreLess(resourceStore.stock)">-</button>-->
    ...
    <!--    <vc:create name="deleteResourceStore"></vc:create>-->
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import EditItemNumberStore from '@/component/EditItemNumberStore.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,EditItemNumberStore
                },
                data () {
                    return {"resourceStoreManageInfo":{"resourceStores":[],"total":0,"records":1,"moreCondition":false,"resName":"","conditions":{"resId":"","resName":"","resCode":"","description":"","stock":""}}}    
                },
                mounted() {
                ( () => {
