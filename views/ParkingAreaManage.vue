    ...
    <vc:create name="deleteParkingArea"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import AddParkingArea from '@/component/AddParkingArea.vue';import EditParkingArea from '@/component/EditParkingArea.vue';import DeleteParkingArea from '@/component/DeleteParkingArea.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,AddParkingArea,EditParkingArea,DeleteParkingArea
                },
                data () {
                    return {"parkingAreaManageInfo":{"parkingAreas":[],"total":0,"records":1,"moreCondition":false,"num":"","conditions":{"num":"","typeCd":"","paId":""}}}    
                },
                mounted() {
                (() => {
