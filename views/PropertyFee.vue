    ...
    <div class="row">
        ...
        <script>
            ...
            import ViewMainFee from '@/component/ViewMainFee.vue';import Pagination from '@/component/Pagination.vue';
            ...
            export default {
                props: {},
                components: {
                    ViewMainFee,Pagination
                },
                data () {
                    return {"feeDetailInfo":{"feeDetails":[],"total":0,"records":1,"feeId":"","startTime":"","endTime":""}}    
                },
                mounted() {
                (() =>{
            this.initDate();
...
(() =>{
            ...
            this.$vc.on('propertyFee','listParkingSpaceData',(_param) =>{
                  this.feeDetailInfo.feeId = _param.feeId;
                  this.listFeeDetail(DEFAULT_PAGE,DEFAULT_ROW);
            });
