    ...
    <vc:create name="deleteUnit"></vc:create>
        ...
        <script>
            ...
            import SearchFloor from '@/component/SearchFloor.vue';import AddUnit from '@/component/AddUnit.vue';import EditUnit from '@/component/EditUnit.vue';import DeleteUnit from '@/component/DeleteUnit.vue';
            ...
            export default {
                props: {},
                components: {
                    SearchFloor,AddUnit,EditUnit,DeleteUnit
                },
                data () {
                    return {"unitInfo":{"units":[],"_currentFloorId":"","moreCondition":false,"conditions":{"floorId":"","floorName":"","unitNum":"","layerCount":"","lift":""}}}    
                },
                mounted() {
                (() =>{
