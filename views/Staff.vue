    ...
    <vc:create name="resetStaffPwd"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import ResetStaffPwd from '@/component/ResetStaffPwd.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,ResetStaffPwd
                },
                data () {
                    return {"staffInfo":{"moreCondition":false,"branchOrgs":[],"departmentOrgs":[],"conditions":{"branchOrgId":"","departmentOrgId":"","orgId":"","orgName":"","orgLevel":"","parentOrgId":"","name":"","tel":"","staffId":""}},"staffData":[]}    
                },
                mounted() {
                (() =>{
                this.loadData(1,10);
...
(() =>{
                 this.$on('pagination_page_event',(_currentPage) =>{
                        this.currentPage(_currentPage);
                    });
                 this.$on('addStaff_reload_event',() =>{
                     this.loadData(1,10);
                 });
                 this.$on('editStaff_reload_event',() =>{
                      this.loadData(1,10);
                  });
                  this.$on('deleteStaff_reload_event',() =>{
                     this.loadData(1,10);
                  });
