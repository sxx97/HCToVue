    ...
    <vc:create name="machineRecordDetail"></vc:create>
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"machineRecordManageInfo":{"machineRecords":[],"total":0,"records":1,"moreCondition":false,"name":"","conditions":{"name":"","openTypeCd":"","tel":"","ownerTypeCd":"","machineName":"","machineCode":""}}}    
                },
                mounted() {
                ( () => {
...
( () => {
            ...
            this.$vc.on('machineRecordManage', 'listMachineRecord',  (_param) => {
                this._listMachineRecords(DEFAULT_PAGE, DEFAULT_ROWS);
            });
