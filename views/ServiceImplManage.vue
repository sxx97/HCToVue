    ...
    <vc:create name="addServiceImpl"
               ...
               callBackFunction=""
    ></vc:create>
    <vc:create name="editServiceImpl"></vc:create>
    <vc:create name="deleteServiceImpl"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import AddServiceImpl from '@/component/AddServiceImpl.vue';import EditServiceImpl from '@/component/EditServiceImpl.vue';import DeleteServiceImpl from '@/component/DeleteServiceImpl.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,AddServiceImpl,EditServiceImpl,DeleteServiceImpl
                },
                data () {
                    return {"serviceImplManageInfo":{"serviceImpls":[],"total":0,"records":1,"moreCondition":false,"name":"","conditions":{"businessTypeCd":"","name":"","invokeType":"","messageTopic":""}}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            ...
            this.$vc.on('serviceImplManage','listServiceImpl',(_param) =>{
                  this._listServiceImpls(DEFAULT_PAGE, DEFAULT_ROWS);
            });
