    ...
    <div class="row">
        ...
        <script>
            ...
            import ViewAppInfo from '@/component/ViewAppInfo.vue';import ViewServiceInfo from '@/component/ViewServiceInfo.vue';import AddRouteView from '@/component/AddRouteView.vue';
            ...
            export default {
                props: {},
                components: {
                    ViewAppInfo,ViewServiceInfo,AddRouteView
                },
                data () {
                    return {"serviceBindingInfo":{"$step":{},"index":0,"infos":[]}}    
                },
                mounted() {
                ( () => {
            this._initStep();
...
( () => {
            this.$vc.on("serviceBinding", "notify",  (_info) => {
