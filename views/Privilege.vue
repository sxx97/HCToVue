    ...
    <vc:create name="deletePrivilege"></vc:create>
        ...
        <script>
            ...
            import PrivilegeGroup from '@/component/PrivilegeGroup.vue';import AddPrivilege from '@/component/AddPrivilege.vue';import DeletePrivilege from '@/component/DeletePrivilege.vue';
            ...
            export default {
                props: {},
                components: {
                    PrivilegeGroup,AddPrivilege,DeletePrivilege
                },
                data () {
                    return {"privilegeInfo":{"_currentPgId":"","_currentPgName":"","_pName":"","_currentStoreId":"9999","_privileges":[]}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            this.$on('privilege_group_event',(_pgObj) =>{
            ...
            this.$on('privilege_loadPrivilege',(_pgId) =>{
