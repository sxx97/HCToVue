   ...
   <!-- <vc:create name="addMenu"
    ...
    <vc:create name="deleteMenu"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import ChooseMenuGroup from '@/component/ChooseMenuGroup.vue';import EditMenu from '@/component/EditMenu.vue';import DeleteMenu from '@/component/DeleteMenu.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,ChooseMenuGroup,EditMenu,DeleteMenu
                },
                data () {
                    return {"menuManageInfo":{"menus":[],"total":0,"records":1,"moreCondition":false,"name":"","conditions":{"gName":"","gId":"","mId":"","mName":"","pId":"","pName":"","domain":"","uName":""}}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            this.$vc.on('menuManage','chooseMenuGroup',(_param) =>{
            ...
            this.$vc.on('menuManage','listMenu',(_param) =>{
                  this._listMenus(DEFAULT_PAGE, DEFAULT_ROWS);
            });
