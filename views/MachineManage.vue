...
<!--                            <th class="text-center">设备MAC</th>-->
    ...
    <vc:create name="machineState"></vc:create>
        ...
        <script>
            ...
            import Pagination from '@/component/Pagination.vue';import AddMachine from '@/component/AddMachine.vue';import EditMachine from '@/component/EditMachine.vue';import DeleteMachine from '@/component/DeleteMachine.vue';import MachineState from '@/component/MachineState.vue';
            ...
            export default {
                props: {},
                components: {
                    Pagination,AddMachine,EditMachine,DeleteMachine,MachineState
                },
                data () {
                    return {"machineManageInfo":{"machines":[],"total":0,"records":1,"moreCondition":false,"machineName":"","conditions":{"machineCode":"","machineTypeCd":"","machineName":"","machineIp":"","machineMac":"","communityId":""}}}    
                },
                mounted() {
                ( () => {
...
( () => {
            ...
            this.$vc.on('machineManage', 'listMachine',  (_param) => {
                this._listMachines(DEFAULT_PAGE, DEFAULT_ROWS);
            });
