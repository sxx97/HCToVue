    ...
    <div class="col-lg-12">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"positionList":[],"addStaffViewInfo":{"flowComponent":"addStaffView","username":"","sex":"","email":"","tel":"","address":"","relCd":"","rfidCard":"","photo":""}}    
                },
                mounted() {
                (() => {
        })()
(() => {
            this.$vc.on('addStaffViewInfo', 'onIndex', (addStaffStepInfo) => {
