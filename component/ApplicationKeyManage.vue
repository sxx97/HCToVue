    ...
    <div v-show="applicationKeyManageInfo.showComponent == 'editApplicationKey'">
        <EditApplicationKey name="editApplicationKey"></EditApplicationKey>
    </div>
    <DeleteApplicationKey name="deleteApplicationKey"></DeleteApplicationKey>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import EditApplicationKey from './EditApplicationKey.vue';import DeleteApplicationKey from './DeleteApplicationKey.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"applicationKeyManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('applicationKeyManage', 'listApplicationKey', function (_param) {
                this._listApplicationKeys(DEFAULT_PAGE, DEFAULT_ROWS);
            });
