    ...
    <option value="">选择部门</option>
        ...
        export default {
            ...
            data () {
                return {"departmentSelect2Info":"[object Object]"}    
            },
            mounted() {
             (function () {
            this._initDepartmentSelect2();
        })()(function () {
            this.$vc.on('departmentSelect2', 'setDepartment', function (_param) {
            ...
            this.$vc.on('departmentSelect2', 'clearDepartment', function (_param) {
