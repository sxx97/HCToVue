    ...
    ></vc:create>
    <!--撤回审核-->
    <RecallAuditEnterFinishCommunity name="recallAuditEnterFinishCommunity"></RecallAuditEnterFinishCommunity>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import RecallAuditEnterFinishCommunity from './RecallAuditEnterFinishCommunity.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"auditEnterCommunityManageInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            this._listCommunitys(DEFAULT_PAGE, DEFAULT_ROWS);
        })()(function(){
            this.$vc.on('auditEnterCommunityManage','listCommunity',function(_param){
                  this._listCommunitys(DEFAULT_PAGE, DEFAULT_ROWS);
            });
            this.$vc.on('auditEnterCommunityManage','notifyAuditInfo',function(_auditInfo){
