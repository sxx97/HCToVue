    ...
    <div class="modal-dialog" role="document">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"deleteFloorInfo":{}}    
                },
                mounted() {
                (undefined)()
(() =>{
             this.$vc.on('deleteFloor','openFloorModel',(_floorInfo) =>{
                    this.deleteFloorInfo = _floorInfo;
                ...
                this.deleteFloorInfo.communityId = this.$vc.getCurrentCommunity().communityId;
                this.$vc.http.post(
                    'deleteFloor',
                    'delete',
                    JSON.stringify(this.deleteFloorInfo),
                    {
                        emulateJSON:true
                     },
                     (json,res) =>{
                        ...
                        this.deleteFloornfo.errorInfo = json;
                     },
                     (errInfo,error) =>{
                        console.log('请求失败处理');

                        this.deleteFloornfo.errorInfo = errInfo;
                     });
            },
                },
            }
