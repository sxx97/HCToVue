    ...
    <option value="">请选择巡检路线</option>
        ...
        export default {
            ...
            data () {
                return {"inspectionRouteSelect2Info":"[object Object]"}    
            },
            mounted() {
             (function () {
            this._initInspectionRouteSelect2();
        })()(function () {
            this.$vc.on('inspectionRouteSelect2', 'setInspectionRoute', function (_param) {
            ...
            this.$vc.on('inspectionRouteSelect2', 'clearInspectionRoute', function (_param) {
