    ...
    <option value="">请选择巡检路线</option>
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"inspectionRouteSelect2Info":{"inspectionRoutes":[],"inspectionRouteId":"","routeName":"","inspectionRouteSelector":{}}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('inspectionRouteSelect2', 'setInspectionRoute',  (_param) => {
                this.$vc.copyObject(_param, this.inspectionRouteSelect2Info);
            ...
            this.$vc.on('inspectionRouteSelect2', 'clearInspectionRoute',  (_param) => {
