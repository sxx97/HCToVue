    ...
    <div class="modal-dialog modal-lg">
        ...
        export default {
            ...
            data () {
                return {"addOrgCommunityInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
        })()(function(){
            this.$vc.on('addOrgCommunity','openAddOrgCommunityModal',function(_param){
            ...
            this.$vc.on('addOrgCommunity','paginationPlus', 'page_event', function (_currentPage) {
