...
<textarea  placeholder="选填，请填写描述" class="form-control" v-model="addMenuInfo.description"></textarea>         </div>
        ...
        export default {
            ...
            data () {
                return {"addMenuInfo":"[object Object]"}    
            },
            mounted() {
             (function(){

         })()(function(){
            this.$vc.on('addMenu','openAddMenuModal',function(){
...
'addMenuInfo.description':[
 {
                ...
                if(this.$vc.notNull(this.$vc._thiscallBackListener)){
                    this.$vc.emit(this.$vc._thiscallBackListener,this.$vc._thiscallBackFunction,this.addMenuInfo);
