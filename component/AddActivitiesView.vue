...
<!--                            <option value="10002">其他</option>-->
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"addActivitiesViewInfo":{"activitiesId":"","title":"","typeCd":"","photos":"","headerImg":"","context":"","startTime":"","endTime":""}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('addActivitiesView', 'openAddActivitiesView',  () => {
                //this._initActivitiesInfo();

            });

            this.$vc.on("addActivitiesView", "notifyUploadImage",  (_param) => {
