...
<!--                                        <th>单元编号</th>-->
        ...
        export default {
            ...
            data () {
                return {"searchRoomInfo":"[object Object]"}    
            },
            mounted() {
             (function(){

        })()(function(){
            this.$vc.on('searchRoom','openSearchRoomModel',function(_param){
            ...
            this.$vc.on('searchRoom','listenerFloorInfo',function(_floorInfo){
                this.searchRoomInfo._currentFloorNum = _floorInfo.floorNum;
                this.searchRoomInfo.floorNumInputReadonly = true;
                this.searchRooms();
            });
            this.$vc.on('searchRoom','showOwnerRooms',function(_rooms){
                $('#searchRoomModel').modal('show');
