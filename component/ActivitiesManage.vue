...
<!--                                <option value="10002">其他</option>-->
    ...
    <div :class="{no_display:activitiesManageInfo.componentShow != 'editActivitiesView'}">
        <EditActivitiesView name="editActivitiesView"></EditActivitiesView>
    </div>

    <DeleteActivities name="deleteActivities"></DeleteActivities>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import EditActivitiesView from './EditActivitiesView.vue';import DeleteActivities from './DeleteActivities.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"activitiesManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('activitiesManage', 'listActivities', function (_param) {
