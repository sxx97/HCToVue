...
<div class="col-sm-4">
    ...
    ></vc:create>
        ...
        <script>
            ...
            import AddBasePrivilege from '@/component/AddBasePrivilege.vue';import ChooseBasePrivilege from '@/component/ChooseBasePrivilege.vue';
            ...
            export default {
                ...
                components: {
                    AddBasePrivilege,ChooseBasePrivilege
                },
                data () {
                    return {"viewBasePrivilegeInfo":{"index":0,"flowComponent":"viewBasePrivilegeInfo","name":"","domain":"","description":""}}    
                },
                mounted() {
                (() =>{
            //根据请求参数查询 查询 业主信息
...
(() =>{
            this.$vc.on('viewBasePrivilegeInfo','chooseBasePrivilege',(_app) =>{
            ...
            this.$vc.on('viewBasePrivilegeInfo', 'onIndex', (_index) =>{
