    ...
    <AddMapping name="addMapping"></AddMapping>
    <EditMapping name="editMapping"></EditMapping>
    <DeleteMapping name="deleteMapping"></DeleteMapping>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import AddMapping from './AddMapping.vue';import EditMapping from './EditMapping.vue';import DeleteMapping from './DeleteMapping.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"mappingManageInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            this._listMappings(DEFAULT_PAGE, DEFAULT_ROWS);
        })()(function(){
            this.$vc.on('mappingManage','listMapping',function(_param){
                  this._listMappings(DEFAULT_PAGE, DEFAULT_ROWS);
            });
