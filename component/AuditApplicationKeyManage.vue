    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"auditApplicationKeyManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            this._listAuditApplicationKeys(DEFAULT_PAGE, DEFAULT_ROWS);
        })()(function () {
            this.$vc.on('auditApplicationKeyManage', 'listApplicationKey', function (_param) {
                this._listAuditApplicationKeys(DEFAULT_PAGE, DEFAULT_ROWS);
            });
            this.$vc.on('auditApplicationKeyManage', 'notifyAuditInfo', function (_auditInfo) {
