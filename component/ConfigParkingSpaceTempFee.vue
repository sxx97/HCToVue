    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"changeFeeTempConfigInfo":{"configId":"","squarePrice":"","feeTypeCd":"","additionalAmount":""}}    
                },
                mounted() {
                (() =>{
...
(() =>{
             this.$vc.on('configFeeTempConfigInfo','openConfigParkingSpaceFeeModel',(_params) =>{
