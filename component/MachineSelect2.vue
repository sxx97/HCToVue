    ...
    <option value="">请选择设备</option>
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"machineSelect2Info":{"machines":[],"machineId":"-1","machineCode":"","machineName":"","machineSelector":{}}}    
                },
                mounted() {
                ( () => {
...
( () => {
            ...
            this.$vc.on('machineSelect2', 'setMachine',  (_param) => {
            ...
            this.$vc.on('machineSelect2', 'clearMachine',  (_param) => {
                ...
                $('#machineSelector').on("select2:select",  (evt) => {
                    //这里是选中触发的事件
                ...
                $('#machineSelector').on("select2:unselect",  (evt) => {
                    //这里是取消选中触发的事件
