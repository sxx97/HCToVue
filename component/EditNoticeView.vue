    ...
    <div class="col-lg-12">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"editNoticeViewInfo":{"noticeId":"","title":"","noticeTypeCd":"","context":"","startTime":"","endTime":"","photos":""}}    
                },
                mounted() {
                ( () => {
...
( () => {
           /* this.$vc.on('editNoticeViewInfo', 'openEditNoticeModal',  (_params) => {
            ...
            this.$vc.on('editNoticeViewInfo', 'noticeEditNoticeInfo',  (_params) => {
                this.refreshEditNoticeInfo();
                if (_params != null) {
                    // _params.context = filterXSS(_params.context);
            ...
            this.$vc.on("editNoticeView", "notifyUploadImage",  (_param) => {
