    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"parkingSpaceCreateFeeAddInfo":{"feeTypeCds":[],"feeConfigs":[],"parkingAreas":[],"locationTypeCd":"","locationObjId":"","psId":"","feeTypeCd":"","configId":"","billType":"","parkingSpaceState":"","isMore":false,"locationTypeCdName":""}}    
                },
                mounted() {
                (() => {
