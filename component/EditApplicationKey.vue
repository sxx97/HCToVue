    ...
    <div class="col-lg-12">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"editApplicationKeyInfo":{"applicationKeyId":"","name":"","tel":"","typeCd":"","sex":"","age":"","idCard":"","startTime":"","endTime":"","floorId":"","floorNum":"","floorName":"","unitId":"","unitNum":"","roomId":"","locationTypeCd":"","locationObjId":"","roomName":"","videoPlaying":false,"photo":"","mediaStreamTrack":null,"typeFlag":""}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('editApplicationKey', 'openEditApplicationKeyModal',  (_params) => {
            ...
            this.$vc.on('editApplicationKey', "_initEditApplicationKeyData",  () => {
                this._initEditApplicationKeyMedia();
            });

            this.$vc.on("editApplicationKey", "notify",  (_param) => {
