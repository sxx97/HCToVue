    ...
    <vc:create name="addBasePrivilege"
               ...
               callBackFunction=""
    ></vc:create>
    <EditBasePrivilege name="editBasePrivilege"></EditBasePrivilege>
    <DeleteBasePrivilege name="deleteBasePrivilege"></DeleteBasePrivilege>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import EditBasePrivilege from './EditBasePrivilege.vue';import DeleteBasePrivilege from './DeleteBasePrivilege.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"basePrivilegeManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('basePrivilegeManage', 'listBasePrivilege', function (_param) {
                this._listBasePrivileges(DEFAULT_PAGE, DEFAULT_ROWS);
            });
