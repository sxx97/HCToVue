    ...
    <StoresCommunity name="storesCommunity"></StoresCommunity>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import StoresCommunity from './StoresCommunity.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"listStoreManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('listStoreManage', 'listListStore', function (_param) {
                this._listListStores(DEFAULT_PAGE, DEFAULT_ROWS);
            });
