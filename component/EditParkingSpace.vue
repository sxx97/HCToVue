    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"editParkingSpaceInfo":{"psId":"","num":"","areaNum":"","paId":"","area":"","remark":""}}    
                },
                mounted() {
                (() =>{
...
(() =>{
            this.$vc.on('editParkingSpace','openEditParkingSpaceModal',(_parkingSpace) =>{
             ...
             this.$vc.on("editParkingSpace", "notify",  (_param) => {
