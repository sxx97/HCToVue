    ...
    <div class="modal-dialog" role="document">
        ...
        <script>
            ...
            export default {
                ...
                (undefined)()
(() =>{
             this.$vc.on('deleteRoom','openRoomModel',(_roomInfo) =>{
                    this.deleteRoomInfo = _roomInfo;
                ...
                this.deleteRoomInfo.communityId = this.$vc.getCurrentCommunity().communityId;
                this.$vc.http.post(
                    'deleteRoom',
                    'delete',
                    JSON.stringify(this.deleteRoomInfo),
                    {
                        emulateJSON:true
                     },
                     (json,res) =>{
                        ...
                        if(res.status == 200){
                            ...
                            this.$vc.emit('room','loadData',{
                                floorId:this.deleteRoomInfo.floorId
                            });
                            return ;
                        }
