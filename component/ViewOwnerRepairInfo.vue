...
<div class="col-sm-4">
    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewOwnerRepairInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewOwnerRepairInfo','chooseOwnerRepair',function(_app){
            ...
            this.$vc.on('viewOwnerRepairInfo', 'onIndex', function(_index){
