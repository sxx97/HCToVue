   ...
   <!-- <vc:create name="searchParkingSpace"
    ...
    <vc:create name="propertyPay"
        ...
        export default {
            ...
            data () {
                return {"mainParkingSpaceFeeInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
             //加载 业主信息
            ...
            this.$vc.on('viewMainParkingSpaceFee','chooseParkingSpace',function(_parkingSPace){
                  this.loadMainParkingSpaceFeeInfo(_parkingSPace);
            });

            this.$vc.on('viewMainParkingSpaceFee','reloadFee',function(_parkingSpace){
