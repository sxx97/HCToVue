    ...
    <div class="modal-dialog" role="document">
        ...
        export default {
            ...
            data () {
                return {"deleteApplicationKeyInfo":"[object Object]"}    
            },
            mounted() {
             (function(){

         })()(function(){
             this.$vc.on('deleteApplicationKey','openDeleteApplicationKeyModal',function(_params){

                this.deleteApplicationKeyInfo = _params;
            ...
            methods: {
                ...
                this.deleteApplicationKeyInfo.communityId=this.$vc.getCurrentCommunity().communityId;
                this.$vc.http.post(
                    'deleteApplicationKey',
                    'delete',
                    JSON.stringify(this.deleteApplicationKeyInfo),
                    {
                        emulateJSON:true
                     },
                     function(json,res){
