...
<div class="col-sm-4">
    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewResourceStoreInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewResourceStoreInfo', 'chooseResourceStore', function (_app) {
            ...
            this.$vc.on('viewResourceStoreInfo', 'onIndex', function (_index) {
