    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewActivitiesInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewActivitiesInfo','chooseActivities',function(_app){
            ...
            this.$vc.on('viewActivitiesInfo', 'onIndex', function(_index){
