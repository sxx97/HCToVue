    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"weekMapping":{"1":"一","2":"二","3":"三","4":"四","5":"五","6":"六","7":"日"},"inspectScheduleType":0,"inspectScheduleData":[],"staffOptionsList":[],"checkedStaffIdMapping":{},"everyDayInspector":[""],"checkedStaffIdList":[]}    
                },
                mounted() {
                (() => {
