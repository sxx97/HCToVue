    ...
    <div class="modal-dialog modal-lg">
        ...
        export default {
            ...
            data () {
                return {"addAdvertInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            this._initAddAdvertDateInfo();
        })()(function () {
            this.$vc.on('addAdvert', 'openAddAdvertModal', function () {
                $('#addAdvertModel').modal('show');
            });

            this.$vc.on("addAdvert", "notify", function (_param) {
            ...
            this.$vc.on("addAdvert", "notifyUploadImage", function (_param) {
                this.addAdvertInfo.photos = _param;
            });
            this.$vc.on("addAdvert", "notifyUploadVedio", function (_param) {
