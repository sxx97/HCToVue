    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewUnitInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewUnitInfo','chooseUnit',function(_app){
            ...
            this.$vc.on('viewUnitInfo', 'onIndex', function(_index){
                this.viewUnitInfo.index = _index;
            });

            this.$vc.on('viewUnitInfo','onFloorInfo',function(_param){
