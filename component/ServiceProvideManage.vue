   ...
   <!-- <vc:create name="addServiceProvide"
               ...
               callBackFunction=""
    ></vc:create>-->
    <EditServiceProvide name="editServiceProvide"></EditServiceProvide>
    <DeleteServiceProvide name="deleteServiceProvide"></DeleteServiceProvide>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import EditServiceProvide from './EditServiceProvide.vue';import DeleteServiceProvide from './DeleteServiceProvide.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"serviceProvideManageInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            ...
            this.$vc.on('serviceProvideManage','listServiceProvide',function(_param){
                  this._listServiceProvides(DEFAULT_PAGE, DEFAULT_ROWS);
            });
