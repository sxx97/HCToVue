    ...
    <vc:create name="addAdvert"
               ...
               callBackFunction=""
    ></vc:create>
    <EditAdvert name="editAdvert"></EditAdvert>
    <DeleteAdvert name="deleteAdvert"></DeleteAdvert>
    <WriteAdvertMachine name="writeAdvertMachine"></WriteAdvertMachine>
        ...
        <script>
            import Pagination from './Pagination.vue';import EditAdvert from './EditAdvert.vue';import DeleteAdvert from './DeleteAdvert.vue';import WriteAdvertMachine from './WriteAdvertMachine.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"advertManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('advertManage', 'listAdvert', function (_param) {
                this._listAdverts(DEFAULT_PAGE, DEFAULT_ROWS);
            });
