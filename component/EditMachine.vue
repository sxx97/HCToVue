    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"editMachineInfo":{"machineId":"","machineCode":"","machineVersion":"","machineName":"","machineTypeCd":"","authCode":"","machineIp":"","machineMac":"","floorId":"","floorNum":"","floorName":"","unitId":"","unitNum":"","roomId":"","locationTypeCd":"","locationObjId":"","roomNum":"","machineUrl":"","direction":""}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('editMachine', 'openEditMachineModal',  (_params) => {
            ...
            this.$vc.on("editMachine", "notify",  (_param) => {
