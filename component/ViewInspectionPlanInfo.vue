    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewInspectionPlanInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewInspectionPlanInfo','chooseInspectionPlan',function(_app){
            ...
            this.$vc.on('viewInspectionPlanInfo', 'onIndex', function(_index){
