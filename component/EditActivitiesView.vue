    ...
    <div class="col-lg-12">
        ...
        export default {
            ...
            data () {
                return {"editActivitiesViewInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
             this._initEditActivitiesInfo();
         })()(function(){
             this.$vc.on('editActivitiesView','openEditActivitiesModal',function(_params){
            ...
            this.$vc.on('editActivitiesView','activitiesEditActivitiesInfo',function(_params){
                this.refreshEditActivitiesInfo();
                if (_params != null){
                    // _params.context = filterXSS(_params.context);
             ...
             this.$vc.on("editActivitiesView", "activityUploadImage", function (_param) {
