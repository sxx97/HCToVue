    ...
    <div class="modal-dialog" role="document">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"deletePrivilegeGroupInfo":{}}    
                },
                mounted() {
                (undefined)()
(() =>{
             this.$on('deletePrivilegeGroup_openDeletePrivilegeGroupModel',(_pGroup) =>{
                    this.deletePrivilegeGroupInfo = _pGroup;
                ...
                console.log("开始删除权限组：",this.deletePrivilegeGroupInfo);
                this.$vc.http.post(
                    'deletePrivilegeGroup',
                    'delete',
                    JSON.stringify(this.deletePrivilegeGroupInfo),
                    {
                        emulateJSON:true
                     },
                     (json,res) =>{
                        ...
                        this.deletePrivilegeGroupInfo.errorInfo = json;
                     },
                     (errInfo,error) =>{
                        console.log('请求失败处理');

                        this.deletePrivilegeGroupInfo.errorInfo = errInfo;
                     });
            },
                },
            }
