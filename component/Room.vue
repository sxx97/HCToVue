...
<!--                            <th data-hide="phone">单价</th>-->
    ...
    ></vc:create>
    <!-- 删除员工权限 -->
    <EditRoom name="editRoom"></EditRoom>
    <DeleteRoom name="deleteRoom"></DeleteRoom>
</div>
        </template>
        <script>
            import Pagination from './Pagination.vue';import EditRoom from './EditRoom.vue';import DeleteRoom from './DeleteRoom.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"roomUnits":"","roomInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            ...
            this.$vc.on('room','listRoom',function(_param){
                  this.listRoom(DEFAULT_PAGE,DEFAULT_ROW);
            });
            this.$vc.on('room','loadData',function(_param){
                  this.listRoom(DEFAULT_PAGE,DEFAULT_ROW);
            });
