    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"communityList":[],"checkedCommunity":{},"departmentList":[],"editOrgInfo":{"orgId":"","orgName":"","orgLevel":"","parentOrgId":"","belongCommunityId":"","description":"","parentOrg":[],"belongCommunitys":[],"department":null}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('editOrg', 'openEditOrgModal',  (_params) => {
