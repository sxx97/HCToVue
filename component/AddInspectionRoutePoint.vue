    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            import PaginationPlus from './PaginationPlus.vue';
        export default {
            ...
            data () {
                return {"addInspectionRoutePointInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
        })()(function(){
            this.$vc.on('addInspectionRoutePoint','openAddInspectionRoutePointModal',function(_param){
            ...
            this.$vc.on('addInspectionRoutePoint','paginationPlus', 'page_event', function (_currentPage) {
