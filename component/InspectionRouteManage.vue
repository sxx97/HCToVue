    ...
    <vc:create name="addInspectionRoute"
               ...
               callBackFunction=""
    ></vc:create>
    <DeleteInspectionRoute name="deleteInspectionRoute"></DeleteInspectionRoute>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import ViewModal from './ViewModal.vue';import DeleteInspectionRoute from './DeleteInspectionRoute.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"orgList":"","staffList":"","staffInfo":"[object Object]","queryParams":"[object Object]","inspectRouteArr":""}    
            },
            mounted() {
             (function(){
            this.getOrgList();
            ...
            this.$vc.on('inspectionRouteManage','listInspectionRoute',function(_param){
                  this._listInspectionRoutes(this.queryParams.pageNo, DEFAULT_ROWS);
            });
            this.$vc.on('inspectionRouteManage','goBack',function(_param){
