    ...
    <div>
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"uploadVedioInfo":{"vedio":{},"fileName":"","realFileName":"","progress":0}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('uploadVedio', 'openAddApplicationKeyModal',  () => {

            });
            this.$vc.on('uploadVedio', 'clearVedio',  () => {
            ...
            this.$vc.on('uploadVedio', 'notifyVedio',  (_fileName) => {
