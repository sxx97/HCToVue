    ...
    <div class="col-lg-12">
        ...
        export default {
            ...
            data () {
                return {"addApplicationKeyInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('addApplicationKey', 'openAddApplicationKeyModal', function () {
                $('#addApplicationKeyModel').modal('show');
            });
            this.$vc.on('addApplicationKey', "_initAddApplicationKeyData", function () {
                this._initAddApplicationKeyMedia();
            });
            this.$vc.on("addApplicationKey", "notify", function (_param) {
