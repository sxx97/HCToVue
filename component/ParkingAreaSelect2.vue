    ...
    <option value="">请选择停车场</option>
        ...
        export default {
            ...
            data () {
                return {"parkingAreaSelect2Info":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            //监听 modal 打开
            this.$vc.on('parkingAreaSelect2', 'setParkingArea', function (_param) {
            ...
            this.$vc.on('parkingAreaSelect2', 'clearParkingArea', function (_param) {
