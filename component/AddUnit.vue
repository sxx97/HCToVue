    ...
    <div class="modal-dialog modal-lg">
        ...
        export default {
            ...
            data () {
                return {"addUnitInfo":"[object Object]"}    
            },
            mounted() {
             (function(){

         })()(function(){
             this.$vc.on('addUnit','openAddUnitModal',function(_params){
             ...
             this.$vc.on('addUnit','addUnitModel',function(_params){
                this.refreshAddUnitInfo();
             ...
             this.$vc.on('addUnit','onFloorInfo',function (_params) {
                 if(_params.hasOwnProperty("floorId") && this.$vc.notNull(_params.floorId)){
                     this.addUnitInfo.floorId = _params.floorId;
                 }
                 this.addUnitInfo.communityId = this.$vc.getCurrentCommunity().communityId;
