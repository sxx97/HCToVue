    ...
    <option value="">请选择单元</option>
        ...
        export default {
            ...
            data () {
                return {"unitSelect2Info":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('unitSelect2', "transferFloor", function (_param) {
                this.$vc.copyObject(_param, this.unitSelect2Info);
            });
            this.$vc.on('unitSelect2', 'setUnit', function (_param) {
                this.$vc.copyObject(_param, this.unitSelect2Info);
            ...
            this.$vc.on('unitSelect2', 'clearUnit', function (_param) {
