    ...
    <!--<div  v-if="orgManageInfo.showBelongCommunity == true">
        <OrgCommunityManage name="orgCommunityManage"></OrgCommunityManage>
    </div>-->
    ...
    <vc:create name="addOrg"
               ...
               callBackFunction=""
    ></vc:create>
    <EditOrg name="editOrg"></EditOrg>
    <DeleteOrg name="deleteOrg"></DeleteOrg>
        ...
        <script>
            import Pagination from './Pagination.vue';import OrgCommunityManage from './OrgCommunityManage.vue';import EditOrg from './EditOrg.vue';import DeleteOrg from './DeleteOrg.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"orgManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            //只查 查询总公司级组织
            this.orgManageInfo.orgTree = [];
            this._listOrgTrees(this.orgManageInfo.orgTree, '1', '', function () {
            ...
            this.$vc.on('orgManage', 'listOrg', function (_param) {
            ...
            this.$vc.on('orgManage','onBack',function(_param){
