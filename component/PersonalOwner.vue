    ...
    <div class="row">
        ...
        export default {
            ...
            data () {
                return {"listOwnerInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            //加载 业主信息
            ...
            this.$vc.on('listOwner', 'chooseRoom', function (_room) {
            ...
            this.$vc.on('listOwner', 'chooseParkingSpace', function (_parkingSpace) {
                this.$vc.jumpToPage("/flow/listParkingSpaceFeeFlow?" + this.$vc.objToGetParam(_parkingSpace));
            });

            this.$vc.on("listOwner", "notify", function (_param) {
