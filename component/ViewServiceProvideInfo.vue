...
<div class="col-sm-4">
    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewServiceProvideInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewServiceProvideInfo','chooseServiceProvide',function(_app){
            ...
            this.$vc.on('viewServiceProvideInfo', 'onIndex', function(_index){
