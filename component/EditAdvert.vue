    ...
    <div class="modal-dialog modal-lg">
        ...
        <script>
            ...
            export default {
                ...
                data () {
                    return {"editAdvertInfo":{"advertId":"","adName":"","adTypeCd":"","classify":"","locationTypeCd":"","locationObjId":"","state":"","seq":"","startTime":"","endTime":"","floorId":"","floorNum":"","floorName":"","unitId":"","unitNum":"","roomId":"","roomNum":"","photos":[],"viewType":"","vedioName":""}}    
                },
                mounted() {
                ( () => {
...
( () => {
            this.$vc.on('editAdvert', 'openEditAdvertModal',  (_params) => {
            ...
            this.$vc.on("editAdvert", "notify",  (_param) => {
            ...
            this.$vc.on("editAdvert", "notifyUploadImage",  (_param) => {
                this.editAdvertInfo.photos = _param;
            });
            this.$vc.on("editAdvert", "notifyUploadVedio",  (_param) => {
