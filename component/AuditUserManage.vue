    ...
    <DeleteAuditUser name="deleteAuditUser"></DeleteAuditUser>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import DeleteAuditUser from './DeleteAuditUser.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"auditUserManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('auditUserManage', 'listAuditUser', function (_param) {
                this._listAuditUsers(DEFAULT_PAGE, DEFAULT_ROWS);
            });
