    ...
    <vc:create name="addService"
               ...
               callBackFunction=""
    ></vc:create>
    <EditService name="editService"></EditService>
    <DeleteService name="deleteService"></DeleteService>

</div>

        </template>
        <script>
            import Pagination from './Pagination.vue';import EditService from './EditService.vue';import DeleteService from './DeleteService.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"serviceManageInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            ...
            this.$vc.on('serviceManage','chooseApp',function(_param){
              this.$vc.copyObject(_param,this.serviceManageInfo.conditions);
            });

            this.$vc.on('serviceManage','listService',function(_param){
                  this._listServices(DEFAULT_PAGE, DEFAULT_ROWS);
            });
