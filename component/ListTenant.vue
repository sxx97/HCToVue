    ...
    ></vc:create>
        ...
        <script>
            ...
            import FloorSelect2 from '@/component/FloorSelect2.vue';import UnitSelect2 from '@/component/UnitSelect2.vue';import RoomSelect2 from '@/component/RoomSelect2.vue';import Pagination from '@/component/Pagination.vue';import EditCompanyOwner from '@/component/EditCompanyOwner.vue';import DeleteOwner from '@/component/DeleteOwner.vue';import SearchRoom from '@/component/SearchRoom.vue';import SearchParkingSpace from '@/component/SearchParkingSpace.vue';
            ...
            export default {
                props: {},
                components: {
                    FloorSelect2,UnitSelect2,RoomSelect2,Pagination,EditCompanyOwner,DeleteOwner,SearchRoom,SearchParkingSpace
                },
                data () {
                    return {"companyListOwnerInfo":{"companyMoreCondition":false,"companyConditions":{"name":"","idCard":"","link":"","ownerId":"","isEnterprise":1,"ownerTypeCd":"1003","floorId":"","floorName":"","unitId":"","roomNum":"","roomId":"","enterpriseName":""},"companyOwners":[]}}    
                },
                mounted() {
                ( () => {
