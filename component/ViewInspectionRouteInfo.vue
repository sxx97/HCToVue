...
<div class="col-sm-4">
    ...
    ></vc:create>
        ...
        export default {
            ...
            data () {
                return {"viewInspectionRouteInfo":"[object Object]"}    
            },
            mounted() {
             (function(){
            //根据请求参数查询 查询 业主信息
            ...
            this.$vc.on('viewInspectionRouteInfo','chooseInspectionRoute',function(_app){
            ...
            this.$vc.on('viewInspectionRouteInfo', 'onIndex', function(_index){
