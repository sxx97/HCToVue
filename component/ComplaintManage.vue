    ...
    <EditComplaint name="editComplaint"></EditComplaint>
    <DeleteComplaint name="deleteComplaint"></DeleteComplaint>
    ...
    <ViewImageModal name="viewImageModal"></ViewImageModal>
        ...
        <script>
            import Pagination from './Pagination.vue';import EditComplaint from './EditComplaint.vue';import DeleteComplaint from './DeleteComplaint.vue';import ViewImageModal from './ViewImageModal.vue';
        export default {
            props: {},
            components: {
            ...
            data () {
                return {"complaintManageInfo":"[object Object]"}    
            },
            mounted() {
             (function () {
            ...
            this.$vc.on('complaintManage', 'listComplaint', function (_param) {
                this._listComplaints(DEFAULT_PAGE, DEFAULT_ROWS);
            });
