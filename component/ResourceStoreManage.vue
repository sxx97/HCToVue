    ...
    <vc:create name="addResourceStore"
               ...
               callBackFunction=""
    ></vc:create>
    <EditResourceStore name="editResourceStore"></EditResourceStore>
    <DeleteResourceStore name="deleteResourceStore"></DeleteResourceStore>
        ...
        <script>
            import Pagination from './Pagination.vue';import EditResourceStore from './EditResourceStore.vue';import DeleteResourceStore from './DeleteResourceStore.vue';
        export default {
            props: {},
            components: {
